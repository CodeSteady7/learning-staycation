...
const expect = chai.expect; // untuk melihat expetasi
const app = require('../app');
const fs = require('fs'); //untuk mengirim file mnggunakan fs(file system)
...
describe('API ENDPOINT TESTING', () => {
	...
	it('POST Booking Page', done => {
		...
		const dataSample = {
			...
			duration: 2,
			bookingStartDate: '9-5-2020',
			bookingEndDate: '12-5-2020',
			firstName: 'chairul',
			lastName: 'ikhsan',
			email: 'chairulikhsan016@gmail.com',
			phoneNumber: '089213131313',
		...
		chai
			...
			.field('idItem', dataSample.idItem) //yang ingin dikirm
			...
			.end((err, res) => {
				...
				expect(res.body.message).to.equal('Success Booking'); //membandingkan apkah isi nya success booking
